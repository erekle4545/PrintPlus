...
const ProductList = () => {
    ...
    const getData = () => {
        ...
        http.get(`product?page=${postPagination}`,{
            params:{
            ...
            return <tr key={index} className={'text_font'}>
                ...
                <td>
                    <div className='d-flex justify-content-end '>
                        ...
                        {item.info?  <Link to={'/product/edit/'+item.id}>
                            <IconButton variant="extended" color={'success'} aria-label="delete">
                                <EditIcon />
                            </IconButton>
                        </Link>:<Link to={'/product/edit/'+item.id}>
                ...
                <div className="card ">
                    <div className="card-header lite-background">
                        <div className="row justify-content-end align-items-center">
                            <div className="col-xl-6 col-sm-6 text-left text-sm-center d-flex">
                                <IconButton onClick={() => navigate('/' + RouteLinks.createProduct)} color='primary'
                                            className='text_font ' variant="contained"><AddIcon/></IconButton>
                    ...
                    <div className="tools-choose-config ">
                        ...
                        <div className="col-xl-2 col-sm-12   p-1">
                            ...
                            <FormControl sx={{width: '100%', padding: '0.2px'}} size="small">
                                ...
                                <Select
                                    ...
                                    label="Status"
                                >
                                    <MenuItem key={options.statuses.active}
                                              value={options.statuses.active}>Active</MenuItem>
                                    <MenuItem key={options.statuses.inactive}
                                              value={options.statuses.inactive}>Inactive</MenuItem>
                        ...
                        <div className="col-xl-2 col-sm-12  text-center p-1">
                            <div>
                                <label htmlFor="page_status"
                                       className='pb-2 font_form_title font-weight-bold'>გასუფთავება</label></div>
                            <IconButton onClick={clear} color='secondary'
                                        variant="contained"><ClearIcon/>Clear</IconButton>
                        </div>
                    </div>

                    {loading.pageList ?
                        <div className='text-center p-5'><CircularProgress/><p>Loading Data...</p></div> : <div>
                            {data.length > 0 ? <>
                                    <table className="table table-striped ">
                                        ...
                                        <tr className={'title_font'}>
                                            ...
                                            <th scope="col " className='text-end '>
                                                <IconButton variant="extended" onClick={() => {
                                                    deleteAlert(checkbox, deleteRow);
