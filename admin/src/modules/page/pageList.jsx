...
const PageList = () => {
    ...
    const getData = () => {
        ...
        http.get(`page?page=${postPagination}`,{
           params:{
          ...
          return <tr key={index} className={'text_font'}>
              ...
              <td>
                  <div className='d-flex justify-content-end '>
                      ...
                      {item.info?  <Link to={'/page/edit/'+item.id}>
                      <IconButton variant="extended" color={'success'} aria-label="delete">
                          <EditIcon />
                      </IconButton>
                      </Link>:<Link to={'/page/edit/'+item.id}>
    ...
    // Delete
    const deleteRow = (id) => {
        http.delete('page/delete/'+id).then((response)=>{
                if(response.status === 200){
                ...
                <div className="card ">
                    <div className="card-header lite-background">
                        <div className="row justify-content-end align-items-center">
                            <div className="col-xl-6 col-sm-6 text-left text-sm-center d-flex" >
                                <IconButton onClick={()=>navigate('/'+RouteLinks.createPage)} color='primary' className='text_font ' variant="contained"><AddIcon/></IconButton>
                                <h5 className="card-title mb-0 p-2">
                                    ...
                                    {translate('allPage',state.lang.code)}
                                </h5>
                            </div>
                    ...
                    <div className="tools-choose-config ">
                        <div className="col-xl-3 col-sm-12  p-1 ">
                            <label htmlFor="combo-box" className='pb-2 font_form_title font-weight-bold'>ტემპლეიტი</label>
                            <Autocomplete
                                size='small'
                                ...
                                sx={{ width: '100%' }}
                                renderInput={(params) => <TextField value={params.id} {...params}  label="tamplate" />}
                            />
                        </div>
