...
export default function UserProfile() {
    ...
    const userEditData = {
        ...
        user_status:state.user&&state.user.user_status,
    ...
    // Edit User Data
    const EditUser = (data) => {
        http.put(`user/update`, data).then((response)=>{
            if(response.status === 200){
                setAddSuccess((Math.random() + 1).toString(36).substring(7))
                alerts.success('წარმატებით განახლდა!')
    ...
    useEffect(()=>{
        setValue('name',state.user&&state.user.name)
        setValue('email',state.user&&state.user.email)
        setValue('phone',state.user&&state.user.phone)
        ...
        <div className="col-md-12 col-xl-12 bg-w">
            <div className="card ">
                ...
                <div className="card-body">
                    <form className="row " onSubmit={handleSubmit(EditUser)}>
                        {/*1 Section*/}
                        <div className="col-xl-8 col-md-8 col-sm-12 ">
                            <div className="mb-3 col-md-12">
                                ...
                                />
                                {errors.name && <div className='form-error-messages-text font_form_text' >{errors.name.message}</div>}
                            </div>
                            <div className="form-group mb-3">
                                ...
                                />
                                <small>
                                    {errors.phone && <div className='form-error-messages-text font_form_text' >{errors.email.message}</div>}
                                </small>
                            </div>
                            <div className="mb-3 col-md-12">
                                ...
                                />
                                {errors.phone && <div className='form-error-messages-text font_form_text' >{errors.phone.message}</div>}
                            </div>

                            <div className="form-group mb-3">
                                <label className='pb-2 font_form_title font-weight-bold'>მიმდინარე პაროლი</label>

                                <input placeholder={'მიმდინარე პაროლი'} className="form-control form-control-lg text_font" type="password"
                                ...
                                <small>
                                    {errors.current_password && <div className='form-error-messages-text font_form_text' >{errors.current_password.message}</div>}
                                </small>
                            </div>

                            <div className="form-group mb-3">
                                <label className='pb-2 font_form_title font-weight-bold'>ახალი პაროლი</label>
                                <input placeholder={'ახალი პაროლი'} className="form-control form-control-lg text_font" type="password"
                                       {...register('password', {
                                           minLength: {
                                               value: 8,
                                               message: formTranslateData.passwordMust
                                ...
                                />
                                <small>
                                    {errors.password && <div className='form-error-messages-text font_form_text' >{errors.password.message}</div>}
                                </small>
                            </div>
                            <div className="form-group mb-3">
                        ...
                        <div className="col-md-4 col-xl-4 col-sm-12 bg-w my-left-side-toolbar" >
                            <div className="form-group mb-3 ">
                                <label  className='pb-2 font_form_title font-weight-bold'><i className="fa fa-id-card"  aria-hidden="true"></i> პოზიცია</label>
                                <input className="form-control form-control-lg text_font"  disabled value={userEditData.position}/>
                            </div>
                            <div className="form-group mb-3 ">
                                <label className='pb-2 font_form_title font-weight-bold'><i className="fa fa-calendar" aria-hidden="true"></i> რეგისტრაციის დრო</label>
                                <input className="form-control form-control-lg text_font"  disabled value={userEditData.created_at}/>
                            </div>
                            <div className="form-group mb-3">
                                <label className='pb-2 font_form_title font-weight-bold'><i className="fa fa-calendar" aria-hidden="true"></i> განახლების დრო</label>
                                <input className="form-control form-control-lg text_font"  disabled value={userEditData.updated_at}/>
                            </div>
                        </div>
                    </form>
                </div>
