...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{url()->previous() }}" onclick="void(0)">{{Language::translate('back')}}</a></li>
    ...
    <div class="about-box-main">
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <div class="banner-frame"> <img width="100%" class="img-fluid" src="{{Helper::getThumbImage(!is_null($page->info)?$page->info->covers:[],config('files.covers.default.id'))}}" alt="" />
                    </div>
                </div>
                <div class="col-lg-8">
