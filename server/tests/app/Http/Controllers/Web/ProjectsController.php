...
class ProjectsController extends Controller
{
    ...
    public function index(Request  $request)
    {
        ...
        if($page->template_id == config('page.templates.projects.id')){
            $projects = Post::where('template_id',$page->template_id)->whereHas('info', function ($query) use ($request) {
                $query->with('covers');
        ...
        return view('web.pages.projects.projects_template',[
            'page'=>$page,
            'projects'=>$projects
        ]);
    }
